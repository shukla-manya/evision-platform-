        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div className="space-y-4 sm:space-y-5">
            ...
            {!isTechnician ? (
              ...
              <p className="text-ev-muted text-sm rounded-lg border border-ev-border bg-ev-surface2/60 px-4 py-3">
                Cart and wishlist are for customer accounts. Use{' '}
                <Link href="/electrician/dashboard" className="font-semibold text-ev-primary hover:underline">
                  Technician home
                </Link>{' '}
                for your jobs.
              </p>

...
export function FloatingWhatsAppChat() {
  ...
  return (
    <a
      ...
      aria-label={label}
    >
      <span className="flex h-14 w-14 shrink-0 items-center justify-center sm:h-[3.75rem] sm:w-[3.75rem]" aria-hidden>
        <svg className="h-8 w-8 sm:h-9 sm:w-9" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden>
      ...
      <span className="hidden max-w-[10.5rem] truncate border-l border-white/25 bg-black/10 px-3 text-xs font-bold leading-tight sm:flex sm:items-center sm:px-3.5 sm:text-[13px]">
        {display}
      </span>
    </a>
  );
